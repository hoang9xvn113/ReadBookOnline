                ...
                if (user.equals("") || password.equals("")) {
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        if (status == 1) {
                                            ...
                                            intent.putExtra("account_name", response.getString("account_name"));

                                            LoadingActivity loadingActivity = new LoadingActivity(SigninActivity.this);
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(SigninActivity.this, "Lỗi mạng", Toast.LENGTH_LONG).show();
                        }
                    }
                    );
